...
from trainer.configs.models.encoders import (BaseEncoderOutput,
                                               CLIPTextConfig, CLIPVisionConfig)
from trainer.distributed import divide, get_tp_world_size
from trainer.layers.activation import get_act_fn
from trainer.layers.linear import (ColumnParallelLinear, QKVParallelLinear,
                                     RowParallelLinear)
from trainer.layers.quantization import QuantizationConfig
from trainer.logger import init_logger
from trainer.models.encoders.base import ImageEncoder, TextEncoder
from trainer.models.encoders.vision import resolve_visual_encoder_outputs
