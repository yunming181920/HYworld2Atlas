...
from trainer.configs.models import VAEConfig
from trainer.distributed import get_sp_parallel_rank, get_sp_world_size
...
class ParallelTiledVAE(ABC):
    ...
    def parallel_tiled_decode(self, z: torch.FloatTensor) -> torch.FloatTensor:
        ...
        # TODO (PY): use trainer distributed methods
