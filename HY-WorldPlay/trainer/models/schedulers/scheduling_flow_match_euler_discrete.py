...
from trainer.models.schedulers.base import BaseScheduler
...
class FlowMatchEulerDiscreteScheduler(SchedulerMixin, ConfigMixin,
    ...
    def add_noise(
        ...
        #     print('add noise', sigma)
        sample = (1 - sigma) * clean_latent.to(torch.float32) + sigma * noise.to(torch.float32)
