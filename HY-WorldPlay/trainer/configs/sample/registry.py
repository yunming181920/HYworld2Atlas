...
from trainer.configs.sample.hunyuan import (FastHunyuanSamplingParam,
                                              HunyuanSamplingParam)
from trainer.configs.sample.stepvideo import StepVideoT2VSamplingParam

# isort: off
from trainer.configs.sample.wan import (
...
SAMPLING_PARAM_REGISTRY: dict[str, Any] = {
    "Trainer/FastHunyuan-diffusers": FastHunyuanSamplingParam,
    "hunyuanvideo-community/HunyuanVideo": HunyuanSamplingParam,
    "Wan-AI/Wan2.1-T2V-1.3B-Diffusers": WanT2V_1_3B_SamplingParam,
    "Wan-AI/Wan2.1-T2V-14B-Diffusers": WanT2V_14B_SamplingParam,
    "Wan-AI/Wan2.1-I2V-14B-480P-Diffusers": WanI2V_14B_480P_SamplingParam,
    "Wan-AI/Wan2.1-I2V-14B-720P-Diffusers": WanI2V_14B_720P_SamplingParam,
    "Trainer/stepvideo-t2v-diffusers": StepVideoT2VSamplingParam,
    "Trainer/FastWan2.1-T2V-1.3B-Diffusers": FastWanT2V480PConfig,
    "Wan-AI/Wan2.2-TI2V-5B-Diffusers": Wan2_2_TI2V_5B_SamplingParam,
    "Trainer/FastWan2.2-TI2V-5B-Diffusers": Wan2_2_TI2V_5B_SamplingParam,
...
def get_sampling_param_cls_for_name(pipeline_name_or_path: str) -> Any | None:
    ...
    if os.path.exists(pipeline_name_or_path):
        ...
        logger.warning(
            "Trainer may not correctly identify the optimal sampling param for this model, as the local directory may have been renamed."
        )
    else:
