...
from trainer.configs.pipelines.wan import (FastWan2_1_T2V_480P_Config,
                                             FastWan2_2_TI2V_5B_Config,
                                             WanI2V480PConfig, WanI2V720PConfig,
                                             WanT2V480PConfig, WanT2V720PConfig)
from trainer.logger import init_logger
from trainer.utils import (maybe_download_model_index,
...
PIPE_NAME_TO_CONFIG: dict[str, type[PipelineConfig]] = {
    "Trainer/FastHunyuan-diffusers": FastHunyuanConfig,
    ...
    "Trainer/FastWan2.1-T2V-1.3B-Diffusers": FastWan2_1_T2V_480P_Config,
    "Trainer/FastWan2.1-T2V-14B-480P-Diffusers": FastWan2_1_T2V_480P_Config,
    "Trainer/FastWan2.2-TI2V-5B-Diffusers": FastWan2_2_TI2V_5B_Config,
    "Trainer/stepvideo-t2v-diffusers": StepVideoT2VConfig,
    "Trainer/Wan2.1-VSA-T2V-14B-720P-Diffusers": WanT2V720PConfig,
...
def get_pipeline_config_cls_from_name(
    ...
    Args:
        pipeline_name_or_path (str): The name or path of the pipeline. This can be:
            - A registered model ID (e.g., "Trainer/FastHunyuan-diffusers")
    ...
    if pipeline_config_cls is None:
        ...
        logger.warning(
            "Trying to use the config from the model_index.json. Trainer may not correctly identify the optimal config for this model in this situation."
        )
