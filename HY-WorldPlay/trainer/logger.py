...
"""Logging configuration for trainer."""
import datetime
import json
import logging
import os
...
DEFAULT_LOGGING_CONFIG = {
    "formatters": {
        "trainer": {
            "class": "trainer.logging_utils.NewLineFormatter",
...
def _configure_trainer_root_logger() -> None:
    ...
    for formatter in logging_config.get("formatters", {}).values():
        ...
        if formatter.get("class") == "trainer.logging.NewLineFormatter":
            formatter["class"] = "trainer.logging_utils.NewLineFormatter"
