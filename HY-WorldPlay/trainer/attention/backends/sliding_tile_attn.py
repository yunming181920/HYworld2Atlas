...
from trainer.distributed import get_sp_group
from trainer.forward_context import ForwardContext, get_forward_context
from trainer.logger import init_logger
from trainer.utils import dict_to_3d_list
...
class SlidingTileAttentionImpl(AttentionImpl):
    ...
    def __init__(
        ...
        **extra_impl_args,
        ...
        config_file = envs.TRAINER_ATTENTION_CONFIG
        if config_file is None:
            raise ValueError("TRAINER_ATTENTION_CONFIG is not set")
