...
from trainer.platforms import AttentionBackendEnum, current_platform
from trainer.utils import STR_BACKEND_ENV_VAR, resolve_obj_by_qualname
...
def get_env_variable_attn_backend() -> AttentionBackendEnum | None:
    '''
    Get the backend override specified by the Trainer attention
...
# TRAINER ATTENTION BACKEND ENVIRONMENT VARIABLE
...
def _cached_get_attn_backend(
    ...
    # previously forced.
    #
    # THIS SELECTION OVERRIDES THE TRAINER_ATTENTION_BACKEND
    ...
    if backend_by_global_setting is not None:
        ...
        backend_by_env_var: str | None = envs.TRAINER_ATTENTION_BACKEND
...
def global_force_attn_backend_context_manager(
    ...
    '''
    Globally force a Trainer attention backend override within a
