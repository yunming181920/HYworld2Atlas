...
from trainer.pipelines.lora_pipeline import LoRAPipeline
...
def build_pipeline(
    ...
    """
    # Get pipeline type
    model_path = trainer_args.model_path
    ...
    pipeline_cls = pipeline_registry.resolve_pipeline_cls(
        pipeline_name, pipeline_type, trainer_args.workload_type)

    # instantiate the pipelines
    pipeline = pipeline_cls(model_path, trainer_args)
