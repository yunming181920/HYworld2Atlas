...
from trainer.platforms.interface import CpuArchEnum, Platform, PlatformEnum
...
class CpuPlatform(Platform):
    ...
    def get_device_communicator_cls(cls) -> str:
        return "trainer.distributed.device_communicators.cpu_communicator.CpuCommunicator"
