...
from trainer.platforms import AttentionBackendEnum
from trainer.platforms.interface import (DeviceCapability, Platform,
                                           PlatformEnum)
...
class MpsPlatform(Platform):
    ...
    def get_device_communicator_cls(cls) -> str:
        ...
        return "trainer.distributed.device_communicators.base_device_communicator.DeviceCommunicatorBase"
