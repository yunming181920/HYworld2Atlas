...
)  # watch out for potetential removal from diffusers
...
def find_nccl_library() -> str:
    ...
    if so_file:
        logger.info(
            "Found nccl from environment variable FASTVIDEO_NCCL_SO_PATH=%s", so_file
        )
    else:
...
def import_pynvml():
    ...
    """
    import wan.third_party.pynvml as pynvml
