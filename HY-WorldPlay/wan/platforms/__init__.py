...
from platforms.interface import AttentionBackendEnum  # noqa: F401
from platforms.interface import Platform, PlatformEnum
from utils import resolve_obj_by_qualname
...
def cuda_platform_plugin() -> str | None:
    ...
    try:
        from utils import import_pynvml
    ...
    return "platforms.cuda.CudaPlatform" if is_cuda else None
...
def mps_platform_plugin() -> str | None:
    ...
    return "platforms.mps.MpsPlatform" if is_mps else None


def cpu_platform_plugin() -> str | None:
    """Detect if CPU platform should be used."""
    # CPU is always available as a fallback
    return "platforms.cpu.CpuPlatform"
...
def rocm_platform_plugin() -> str | None:
    ...
    return "platforms.rocm.RocmPlatform" if is_rocm else None
...
def __getattr__(name: str):
    if name == "current_platform":
        ...
        if _current_platform is None:
            platform_cls_qualname = resolve_qualname()
